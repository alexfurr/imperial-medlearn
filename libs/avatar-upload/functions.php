...
*	---
*/
function get_user_avatar( $userID, $size = '' )
{
	$url = get_user_avatar_url( $userID, $size );
...
{
	$url = get_user_avatar_url( $userID );
...
*	---
*/
function get_user_avatar_url( $userID, $size = '' )
{
    ...
    $default_avatar = get_stylesheet_directory_uri() . '/assets/images/user-default.png';
